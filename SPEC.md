...
9. 🚧 **Change 8: app-polish-fixes — Polish UX + notificaciones + MCP fijos** (tasks 2026-08-01, rama `feat/app-polish-fixes`)
...
> **Roadmap:** Changes 1–7 en prod. Change 8 con `tasks.md` (pendiente implement).
